const CustomReporter = require('./src/reporter/CustomReporter.js');
exports.config = {
    // ...
    //...
    // ==================
   ...
   //  },
    ...
    afterStep: function (stepResult) {
        if(stepResult.getStatus() === 'failed' && stepResult.getFailureException() !== undefined){
            const UtilsPage = require('./src/pages/utils_page.js');
            var scenarioName = stepResult.getStep().getScenario().getName();
            if(!scenarioName){
